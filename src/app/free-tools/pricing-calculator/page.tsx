          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div className="space-y-6">
              ...
              <button
                ...
                className="w-full bg-white text-green-600 font-semibold px-6 py-3 rounded-lg hover:bg-white/90 transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed"
              >
                Calculate Pricing
              </button>
            </div>
            ...
            <div>
              <h2 className="text-2xl font-semibold text-white mb-6">Pricing Results</h2>
              
              {results ? (
                <div className="space-y-6">
                  <div className="bg-white/10 rounded-lg p-6">
                    <h3 className="text-lg font-semibold text-white mb-4">Recommended Pricing</h3>
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div className="bg-white/10 rounded-lg p-4">
                      <h4 className="text-sm font-medium text-white/80 mb-2">Minimum Price</h4>
                      <div className="text-xl font-bold text-yellow-400">
                        ${results.minimumPrice}
                      </div>
                      <p className="text-white/60 text-xs">Break-even + 10%</p>
                    </div>

                    <div className="bg-white/10 rounded-lg p-4">
                      <h4 className="text-sm font-medium text-white/80 mb-2">Break-Even</h4>
                      <div className="text-xl font-bold text-red-400">
                        ${results.breakEvenPrice}
                      </div>
                      <p className="text-white/60 text-xs">No profit/loss</p>
                    </div>
                  </div>

                  <div className="bg-white/10 rounded-lg p-4">
                    <h4 className="text-sm font-medium text-white/80 mb-2">Profit per Unit</h4>
