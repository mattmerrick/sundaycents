        ...
        <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-8 border border-white/20 shadow-xl">
          <div className="grid md:grid-cols-2 gap-8">
            <div className="space-y-6">
              <h2 className="text-2xl font-semibold text-white mb-6">Add Your Tasks</h2>
              ...
              <div className="flex gap-3">
                <input
                  ...
                  className="flex-1 px-4 py-3 rounded-lg bg-white/20 border border-white/30 text-white placeholder-white/60 focus:outline-none focus:ring-2 focus:ring-white/50 disabled:opacity-50"
                />
                <button
                  onClick={addTask}
                  disabled={!newTask.trim() || usageCount >= 3}
                  className="bg-white text-indigo-600 font-semibold px-6 py-3 rounded-lg hover:bg-white/90 transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed"
                >
                  Add
                </button>
              </div>
              ...
              {usageCount >= 3 && (
                <div className="bg-yellow-500/20 border border-yellow-500/30 rounded-lg p-4">
                  <h3 className="text-lg font-semibold text-white mb-2">Upgrade for Unlimited Tasks</h3>
                  <p className="text-white/90 text-sm mb-3">
                    You've added all your free tasks. Upgrade to continue using this tool unlimited times.
                  </p>
                  <button className="bg-yellow-500 hover:bg-yellow-600 text-white font-semibold px-4 py-2 rounded-lg transition-all duration-200 text-sm">
                    Upgrade Now
                  </button>
                </div>
              )}
            ...
            <div>
              <div className="bg-white/10 rounded-lg p-6 h-full">
                <div className="flex items-center justify-between mb-6">
                  <h3 className="text-xl font-semibold text-white">Prioritized Tasks</h3>
          ...
          {tasks.length > 0 && (
            <div className="mt-8 bg-white/10 rounded-lg p-6">
              <h3 className="text-lg font-semibold text-white mb-4">💡 Focus Strategy</h3>
