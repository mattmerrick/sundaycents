...
export const metadata: Metadata = {
  title: 'Day 35 - The funny thing is, they go so fast | Matt Merrick',
  description: 'Day 35 of writing one email daily. Thoughts on trains, time, and making the most of your daily commute.',
  keywords: 'daily writing, newsletter, time management, productivity, Matt Merrick',
  authors: [{ name: 'Matt Merrick' }],
  creator: 'Matt Merrick',
  publisher: 'Matt Merrick',
  robots: 'index, follow',
  alternates: {
    canonical: 'https://www.mattmerrick.com/day-35'
  },
  openGraph: {
    title: 'Day 35 - The funny thing is, they go so fast | Matt Merrick',
    description: 'Day 35 of writing one email daily. Thoughts on trains, time, and making the most of your daily commute.',
    ...
    url: 'https://www.mattmerrick.com/day-35',
    images: [
      {
        url: '/share.png',
        width: 1200,
        height: 630,
        alt: 'Matt Merrick - Day 35',
      },
    ],
  },
  twitter: {
